...
class BiliBiliLivePlatform(LivePlatformInterface):
    ...
    def __init__(self, room_ids: List[int], sessdata: str = ""):
        ...
        if not BLIVEDM_AVAILABLE:
            raise ImportError("blivedm library is required for BiliBili live functionality")
    ...
    async def send_message(self, text: str) -> bool:
        ...
        logger.warning("BiliBili Live platform doesn't support sending messages back to the live room")
        return False
    ...
    class VtuberHandler(BaseHandler):
        ...
        def _on_heartbeat(self, client: blivedm.BLiveClient, message: web_models.HeartbeatMessage):
            ...
            """
            logger.debug(f"[Room {client.room_id}] Heartbeat, popularity: {message.popularity}")
