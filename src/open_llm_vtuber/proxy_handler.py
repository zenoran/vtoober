...
class ProxyHandler:
    ...
    async def handle_client_connection(self, websocket: WebSocket):
        ...
        logger.info(f"Client {client_id} connected to proxy. Total clients: {len(self.clients)}")
        ...
        try:
            ...
            while True:
                ...
                # Handle interrupt signals
                    ...
                    logger.info("Received interrupt signal, marking conversation as inactive")
    ...
    async def handle_client_disconnect(self, client_id: str):
        ...
        logger.info(f"Client {client_id} removed. Remaining clients: {len(self.clients)}")
    ...
    async def broadcast_to_clients(self, message: dict, exclude_client: Optional[str] = None):
        ...
        log_msg = message.copy() if "audio" not in message else {
